...
function Fridge() {
  ...
  const handleSubmit = (e) => {
    ...
    console.log(body, "1 step closer");
  };
      ...
      <div className="form-container">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="category">
            ...
            <select className="Select" placeholder="Select" name="category">
          ...
          <div className="expirationDate">
            <label className="expirationDate-label" htmlFor="expiration">
              Expiration Date:
            </label>
            <input
              className="expirationDate-input"
              type="date"
          ...
          <div className="dateAdded">
            <label className="dateAdded-label" htmlFor="dateAdded">
              Date Added
            </label>
            <input
              className="dateAdded-input"
              type="date"
          ...
          <div className="isOpened">
            <label className="isOpened-label" htmlFor="isOpened">
              Opened:
            </label>
            <input
              className="isOpened-input"
              type="checkbox"
